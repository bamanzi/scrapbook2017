...
#search-box #keywords { width: 95px; background-color: rgb(255, 255, 255); }
#search-box input { border: 1px solid rgb(176, 176, 176); }
...
ul.linklist li.rightside, p.rightside { float: right; margin-right: 0px; margin-left: 5px; text-align: right; }
ul.navlinks { padding-bottom: 1px; margin-bottom: 1px; border-bottom: 1px solid rgb(255, 255, 255); font-weight: bold; }
...
.postlink { text-decoration: none; color: rgb(210, 210, 210); border-bottom: 1px solid rgb(210, 210, 210); padding-bottom: 0px; }
.postlink:active { color: rgb(210, 210, 210); }
.postlink:hover { background-color: rgb(246, 246, 246); text-decoration: none; color: rgb(64, 64, 64); }
...
a.top { background: rgba(0, 0, 0, 0) none no-repeat scroll left top; text-decoration: none; width: 11px; height: 11px; display: block; float: right; overflow: hidden; letter-spacing: 1000px; text-indent: 11px; }
a.left { background: rgba(0, 0, 0, 0) none no-repeat scroll 3px 60%; }
...
.postbody { padding: 0px; line-height: 1.48em; color: rgb(51, 51, 51); width: 76%; float: left; clear: both; }
...
.signature { margin-top: 1.5em; padding-top: 0.2em; font-size: 1.1em; border-top: 1px solid rgb(204, 204, 204); clear: left; line-height: 140%; overflow: hidden; width: 100%; }
blockquote { background: rgb(235, 235, 235) none no-repeat scroll 6px 8px; border: 1px solid rgb(219, 219, 219); font-size: 0.95em; margin: 0.5em 1px 0px 25px; overflow: hidden; padding: 5px; }
blockquote cite { font-style: normal; font-weight: bold; margin-left: 20px; display: block; font-size: 0.9em; }
blockquote.uncited { padding-top: 25px; }
.postprofile { margin: 5px 0px 10px; min-height: 80px; color: rgb(102, 102, 102); border-left: 1px solid rgb(255, 255, 255); width: 22%; float: right; display: inline; }
...
a.fontsize { background-image: none; background-position: 0px -1px; width: 29px; }
a.fontsize:hover { background-position: 0px -20px; text-decoration: none; }
.sitehome, .icon-faq, .icon-members, .icon-home, .icon-ucp, .icon-register, .icon-logout, .icon-bookmark, .icon-bump, .icon-subscribe, .icon-unsubscribe, .icon-pages, .icon-search { background-position: 0px 50%; background-repeat: no-repeat; background-image: none; padding: 1px 0px 0px 17px; }
...
ul.profile-icons li a:hover { background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; }
.web-icon, .web-icon a { background: rgba(0, 0, 0, 0) none no-repeat scroll left top; }
...
.inputbox:focus { border: 1px solid rgb(234, 234, 234); color: rgb(75, 75, 75); }
...
#search-box #keywords { background-color: rgb(255, 255, 255); }
#search-box input { border-color: rgb(0, 117, 176); }
.headerbar { background-color: rgb(18, 163, 235); background-image: url("bg_header.gif"); color: rgb(255, 255, 255); }
...
ul.navlinks { border-bottom-color: rgb(255, 255, 255); }
...
.postlink { color: rgb(54, 138, 210); border-bottom-color: rgb(54, 138, 210); }
.postlink:visited { color: rgb(93, 143, 189); border-bottom-color: rgb(93, 143, 189); }
.postlink:active { color: rgb(54, 138, 210); }
.postlink:hover { background-color: rgb(208, 228, 246); color: rgb(13, 68, 115); }
...
a.top { background-image: url("icon_back_top.gif"); }
...
.signature { border-top-color: rgb(204, 204, 204); }
blockquote { background-color: rgb(235, 234, 221); background-image: url("quote.gif"); border-color: rgb(219, 219, 206); }
...
a.print { background-image: url("icon_print.gif"); }
a.fontsize { background-image: url("icon_fontsize.gif"); }
...
.web-icon, .web-icon a { background-image: url("icon_contact_www.gif"); }
...
input.search { background-image: url("icon_textbox_search.gif"); }
